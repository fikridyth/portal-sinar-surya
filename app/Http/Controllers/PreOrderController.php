...
class PreOrderController extends Controller
{
    ...
    public function daftarPo()
    {
        ...
        $suppliers = Supplier::where('status', 1)->where('waktu_kunjungan', '!=', 0)->where('hari', '=', $today)->get();
        $supplierIds = Supplier::where('status', 1)->where('waktu_kunjungan', '!=', 0)->where('hari', '=', $today)->pluck('id')->toArray();
        // dd(count($suppliers));
