...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('master.langganan.update', enkrip($langganan->id)) }}" method="POST" class="form"
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="nomor" name="nomor" disabled value="{{ $langganan->nomor }}"
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="nama" name="nama" autofocus value="{{ $langganan->nama }}"
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="alamat1" name="alamat1" value="{{ $langganan->alamat1 }}"
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="alamat2" name="alamat2" value="{{ $langganan->alamat2 }}"
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="kota" name="kota" value="{{ $langganan->kota }}"
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="kontak" name="kontak" value="{{ $langganan->kontak }}"
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="telepon" name="telepon" value="{{ $langganan->telepon }}"
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="fax" name="fax" value="{{ $langganan->fax }}"
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="zona" name="zona" value="{{ $langganan->zona }}"
