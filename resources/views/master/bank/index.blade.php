                        ...
                        <table id="promoTable" class="table table-bordered" style="font-size: 13px;">
                            ...
                            <tbody id="promoTableBody">
                                @foreach ($banks as $bank)
                                    <tr data-id="{{ $bank->id }}">
                                        <td>{{ $bank->supplier->nama }}</td>
                                        <td class="supplier" hidden>{{ $bank->supplier->id }}</td>
                                        <td class="date_first text-center">{{ $bank->date_first }}</td>
                                        <td class="date_last text-center">{{ $bank->date_last }}</td>
                                        <td class="total text-end">{{ number_format($bank->total, 0) }}</td>
                                        <td class="tipe">{{ $bank->tipe }}</td>
