                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <input type="text" id="kode" name="kode" value="{{ $product->kode }}"
                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <input type="text" id="kode_alternatif" name="kode_alternatif" value="{{ $product->kode_alternatif ?? old('kode_alternatif') }}"
                    ...
                    <div class="col-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col mx-n2">
                                <input type="text" id="nama_barang" name="nama_barang" value="{{ $product->nama ?? old('nama_barang') }}" required
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <input type="text" id="merek" name="merek" value="{{ $product->merek ?? old('merek') }}"
                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-3">
                                <input type="text" id="unit_beli" name="unit_beli" readonly value="{{ $product->unit_beli ?? old('unit_beli') }}" required
                                    class="form-control readonly-input @error('unit_beli') is-invalid @enderror uppercase-input" autocomplete="off"
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <input type="text" id="label" name="label" value="{{ $product->label ?? old('label') }}"
                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-3">
                                <input type="text" id="unit_jual" name="unit_jual" value="{{ $product->unit_jual ?? old('unit_jual') }}"
                    ...
                    <div class="col-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <input type="text" id="profit" name="profit" value="{{ $product->profit ?? old('profit') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <input type="text" id="harga_pokok" name="harga_pokok" value="{{ $product->harga_pokok ?? old('harga_pokok') }}" required
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <input type="text" id="harga_jual" name="harga_jual" value="{{ $product->harga_jual ?? old('harga_jual') }}" required
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <div class="custom-select-supplier">
                                    <input type="text" class="search-input-supplier" id="input-supplier-id" name="supplier" value="{{ $product->supplier->nomor ?? old('supplier') }}" autocomplete="off"
