    ...
    <div class="container">
        ...
        <form action="{{ route('master.product.update', $product->id) }}" method="POST" class="form" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col mx-n2">
                                <input type="text" id="nama_barang" name="nama_barang" value="{{ old('nama_barang', $product->nama) }}" required
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <input type="text" id="ppn" name="ppn" value="{{ old('ppn', $product->ppn) }}"
                                    class="form-control readonly-input @error('ppn') is-invalid @enderror" autocomplete="off" readonly />
                            </div>
                            <div class="col-1">
                                <label class="form-label h6 mt-2">%</label>
                            </div>
            ...
            <div class="row d-flex justify-content-center" style="margin: 20px; padding: 0 50px 0 50px;">
                ...
                <div class="col-2 mx-5">
                    <button type="submit" class="btn btn-primary btn-block mt-4 mb-7">SAVE</button>
                </div>
                <div class="col-2 mx-5">
