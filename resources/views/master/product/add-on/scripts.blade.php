...
<script>
    ...
    function updateValues() {
        ...
        hargaJualProfit.value = hargaJualProfit.value;
        hargaPokokProfit.value = hargaPokokProfit.value;
        inputField2.value = hargaPokokProfit.value;
    }
    ...
    function handleProfitInput() {
        ...
        hargaJualProfit.value = hargaJual; // Format nilai harga jual dengan Rupiah
