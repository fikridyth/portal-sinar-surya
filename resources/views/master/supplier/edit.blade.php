...
@section('content')
    <div class="container">
        <form action="{{ route('master.supplier.update', enkrip($supplier->id)) }}" method="POST" class="form"
            ...
            <div class="container mb-4" style="border: 1px solid #000000; padding: 15px;">
                <div class="row mb-1">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-3">
                                <input type="text" name="wilayah" value="{{ $supplier->wilayah }}"
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" name="kontak" value="{{ $supplier->kontak }}"
                ...
                <div class="row mb-1">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" name="alamat1" value="{{ $supplier->alamat1 }}"
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" name="kontak1" value="{{ $supplier->kontak1 }}"
                ...
                <div class="row mb-1">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" name="alamat2" value="{{ $supplier->alamat2 }}"
                ...
                <div class="row mb-1">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" name="alamat3" value="{{ $supplier->alamat3 }}"
                ...
                <div class="row mb-1">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-3">
                                <input type="text" name="tcrd" value="{{ $supplier->tcrd }}"
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="text" name="hp" value="{{ $supplier->hp }}"
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2">
                                <input type="text" name="disc" value="{{ $supplier->disc }}"
                ...
                <div class="row mb-1">
                    <div class="col-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-3">
                                <input type="text" name="tanda" value="{{ $supplier->tanda }}"
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2">
                                <input type="text" name="waktu_kunjungan" value="{{ $supplier->waktu_kunjungan }}"
                            ...
                            <div class="col-3">
                                <select name="hari" required class="form-control @error('hari') is-invalid @enderror">
                                    ...
                                    <option value="SENIN" {{ (old('hari') ?? $supplier->hari ?? '') == 'SENIN' ? 'selected' : '' }}>SENIN</option>
                                    <option value="SELASA" {{ (old('hari') ?? $supplier->hari ?? '') == 'SELASA' ? 'selected' : '' }}>SELASA</option>
                                    <option value="RABU" {{ (old('hari') ?? $supplier->hari ?? '') == 'RABU' ? 'selected' : '' }}>RABU</option>
                                    <option value="KAMIS" {{ (old('hari') ?? $supplier->hari ?? '') == 'KAMIS' ? 'selected' : '' }}>KAMIS</option>
                                    <option value="JUMAT" {{ (old('hari') ?? $supplier->hari ?? '') == 'JUMAT' ? 'selected' : '' }}>JUMAT</option>
                                    <option value="SABTU" {{ (old('hari') ?? $supplier->hari ?? '') == 'SABTU' ? 'selected' : '' }}>SABTU</option>
                                    <option value="MINGGU" {{ (old('hari') ?? $supplier->hari ?? '') == 'MINGGU' ? 'selected' : '' }}>MINGGU</option>
                                </select>
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2">
                                <input type="text" name="stok_minimum" value="{{ $supplier->stok_minimum }}"
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2">
                                <input type="text" name="stok_maksimum" value="{{ $supplier->stok_maksimum }}"
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2">
                                <input type="text" name="penjualan_rata" value="{{ $supplier->penjualan_rata }}"
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-8">
                            ...
                            <div class="col-2">
                                <input type="text" name="materai" value="{{ $supplier->materai }}"
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4">
                                <input type="text" name="koli" value="{{ $supplier->koli }}"
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4">
                                <input type="text" name="bonus" value="{{ $supplier->bonus }}"
