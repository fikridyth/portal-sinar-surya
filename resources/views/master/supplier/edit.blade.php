...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('master.supplier.update', $supplier->id) }}" method="POST" class="form" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mt-4 mb-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" id="nomor" name="nomor" value="{{ old('nomor', $supplier->nomor) }}" required
            ...
            <div class="mb-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" id="nama" name="nama" value="{{ old('nama', $supplier->nama) }}" required
            ...
            <div class="mb-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" id="alamat1" name="alamat1" value="{{ old('alamat1', $supplier->alamat1) }}" required
            ...
            <div class="mb-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" id="alamat2" name="alamat2" value="{{ old('alamat2', $supplier->alamat2) }}" required
