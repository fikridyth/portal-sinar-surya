    ...
    <div class="container">
        ...
        <form action="{{ route('master.supplier.store') }}" method="POST" class="form" enctype="multipart/form-data">
            ...
            <div class="row d-flex justify-content-start mb-7">
                <div class="col-0-5">
                    <a href="#" class="btn btn-success disabled-link" title="TAMBAH DATA"><i
                            class="fas fa-plus"></i></a>
                </div>
                <div class="col-0-5">
                    <a href="#" class="btn btn-warning disabled-link" title="EDIT DATA"><i
                ...
                <div class="col-0-5 ml-auto">
                    <a href="{{ route('master.supplier.index') }}" class="btn btn-primary" title="CARI DATA"><i
                            class="fas fa-search"></i></a>
                </div>
                <div class="col-0-5">
                    <button type="button" onclick="window.history.back()" class="btn btn-warning" title="KEMBALI"><i
                            class="fas fa-arrow-left"></i></button>
                </div>
                <div class="col-0-5">
                    <a href="{{ route('index') }}" class="btn btn-danger" title="KELUAR"><i
