    ...
    <div class="container">
        ...
        <form action="#" method="POST" class="form"
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="kode" name="kode"
                                    value="{{ old('kode', $departemen->nama) }}"
                                    class="form-control readonly-input @error('kode') is-invalid @enderror"
                                    autocomplete="off" readonly />
                            </div>
                        </div>
                    ...
                    <div class="col-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="kode" name="kode"
                                    value="{{ old('kode', $departemen->unit->nama) }}"
                                    class="form-control readonly-input @error('kode') is-invalid @enderror"
                                    autocomplete="off" readonly />
                            </div>
                        </div>
            ...
            <div class="row d-flex justify-content-start mb-7">
                <div class="col-0-5">
                    <a href="{{ route('master.departemen.create', $departemen->id) }}" class="btn btn-success" title="TAMBAH DATA"><i class="fas fa-plus"></i></a>
                </div>
                <div class="col-0-5">
                    <a href="{{ route('master.departemen.edit', $departemen->id) }}" class="btn btn-warning" title="EDIT DATA"><i class="fas fa-edit"></i></a>
                </div>
                <div class="col-0-5">
