...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('master.departemen.update', $departemen->id) }}" method="POST" class="form" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mt-5">
            ...
            <div class="mt-5 mb-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" id="nama" name="nama" value="{{ old('nama', $departemen->nama) }}" required
