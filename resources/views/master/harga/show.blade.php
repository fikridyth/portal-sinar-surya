                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td><input type="number" name="" required value="{{ $product->harga_lama }}" style="width: 100px;"></td>
                                            <td><input type="number" name="" required value="{{ $product->harga_pokok }}" style="width: 100px;"></td>
                                            <td>{{ number_format((($product->harga_pokok - $product->harga_lama) / $product->harga_lama) * 100, 2) }}</td>
                                            <td><input type="number" name="" required value="{{ $product->harga_jual }}" style="width: 100px;"></td>
                                            <td>{{ $product->profit }}</td>
                                            <td><input type="number" name="" value="{{ $product->harga_sementara ?? 0 }}" style="width: 100px;"></td>
                                            <td><input type="date" name="" value="{{ $product->tanggal_awal }}" style="width: 100px;"></td>
                                            <td><input type="date" name="" value="{{ $product->tanggal_akhir }}" style="width: 100px;"></td>
