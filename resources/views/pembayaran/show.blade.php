                        ...
                        <div class="row w-100">
                            <div class="form-group col-5">
                                ...
                                <div class="row mb-1 mt-3">
                                    ...
                                    <div class="col-2" style="background-color: brown;">
                                        <input type="radio" checked id="giro" name="rekening" value="GR">
                            ...
                            <div class="form-group col-7">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-2">
                                                <input type="number" autofocus class="btn-block" required min="0" max="2" autocomplete="off" id="jumlah-check" name="type_payment">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2"></div>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-2">
                                        ...
                                        @if ($pembayaran->beban_materai !== null && $pembayaran->beban_materai !== 0)
                                            <input type="text" class="text-end btn-block readonly-input" readonly value="{{ number_format($pembayaran->beban_materai, 0) }}" style="font-size: 12px;">
                                        @else
